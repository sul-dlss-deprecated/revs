...
describe("Collection Pages",:type=>:request,:integration=>true) do
  ...
  it "should show details of the first collection with an image, which is the highest priority image for that collection" do
    ...
    expect(page).to have_selector("img", :alt => "Thompson Raceway, May 1")
    expect(page).to have_selector("img", :src => "https://stacks.stanford.edu/image/td830rb1584/2012-027NADI-1966-b1_2.0_0021_thumb")
  end
