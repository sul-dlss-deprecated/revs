...
describe SolrDocument, :integration => true do
  ...
  describe "rights and copyright" do
    ...
    it "should retrieve the default rights and copyright statements if not found in solr document" do
      ...
      expect(doc.use_and_reproduction).to eq("Users must contact the The Revs Institute for Automotive Research for re-use and reproduction information.")
      expect(doc.copyright).to eq("Courtesy of the Revs Institute for Automotive Research. All rights reserved unless otherwise indicated.")
    end
