Revs::Application.configure do  
  ...
  config.featured_contributors=['tvc15','Doug Nye','Bergeleven','trigwell','Rupertlt1','Duncan'] # array of usernames of featured contributors for about top contributors page...will be shown in this order, use an empty array if none
