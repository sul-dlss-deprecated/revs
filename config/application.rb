...
Revs::Application.config.contact_us_cc_recipients = {'default'=>'', 'metadata'=>'','terms of use'=>'info@revs-institute.org', 'error'=>''} # sets the CC email address for each contact us topic configed above
